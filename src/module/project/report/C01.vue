<template>
  <a-card
    ...
    <a-table
      ...
      :scroll="{ x: 2780, y: listScrollHeight }">
      >
...
import { getPmoneyAll, exportPmoneyAll } from '@/api/projectReport_manpowercost'
...
export default {
  ...
  methods: {
    ...
    doExport () {
      ...
      params.context = this.$route.meta.title + '-C01' // 菜单名称
      params.personId = store.getters.userInfo.personId // 用户id
      params.system = 13 // 系统
      this.isDownloading = true
      exportPmoneyAll(params).then(res => {
