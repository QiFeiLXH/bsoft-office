<template>
  <a-card
    ...
    <a-table
      ...
      :scroll="{ x: 2040, y: listScrollHeight }">
      >
...
import { exportCmoneyAll, getCmoneyAll } from '@/api/projectReport_manpowercost'
...
export default {
  ...
  methods: {
    ...
    doExport () {
      ...
      params.context = this.$route.meta.title + '-C07' // 菜单名称
      params.personId = store.getters.userInfo.personId // 用户id
      params.system = 13 // 系统
      this.isDownloading = true
      exportCmoneyAll(params).then(res => {
