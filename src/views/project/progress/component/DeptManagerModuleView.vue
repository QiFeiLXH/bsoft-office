        ...
        <div :style="{ height: formHeight + 'px',paddingBottom: '50px', overflowY: 'auto' }">
          <a-form-model :model="managerForm" ref="managerForm" :rules="managerFormRules">
            ...
            <a-form-model-item
              ...
              style="margin-bottom: 10px;"
            >
              <multipe-person-search-select :record="managerForm" customKey="manager" customLabel="managerName" style="width: 400px;color: #000000" :disabled="readOnly"></multipe-person-search-select>
            </a-form-model-item>
            <a-form-model-item
              label="备注"
              :labelCol="{lg: {span: 5}, sm: {span: 2}}"
            ...
            <!--<a-form-model-item
              ...
              style="margin-bottom: 10px;"
            >
              <a-switch :checked="managerForm.logout === 1"/>
            </a-form-model-item>-->
          </a-form-model>
        </div>
        <div
...
<script>
import { loadDeptManagerList, doLoadDeptManagerHead } from '@/api/regionProgressManager'
import { MultipePersonSearchSelect } from '@/module'

export default {
  name: 'DeptManagerModuleView',
  components: {
